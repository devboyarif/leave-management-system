                ...
                <div class="card-body row justify-content-center">
                    <div class="col-lg-6">
                        <form @submit.prevent="createData">
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    <Label :name="__('Company')" for="company"/>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input v-model="form.name" type="text" class="form-control"
                                        :class="{'is-invalid':form.errors.name}" id="leave_type" :placeholder="__('Leave Type')">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input min="1" v-model="form.balance" class="form-control" type="number"
                                        :class="{'is-invalid':form.errors.balance}" :placeholder="__('Leave Balance')" id="leave_bal"/>
