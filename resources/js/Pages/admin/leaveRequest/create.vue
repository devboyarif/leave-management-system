            ...
            <div class="card mt-3">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <Link :href="route('leaveRequests.index')" class="btn btn-primary">
                ...
                <div class="card-body row justify-content-center">
                   <div class="col-lg-8">
                     <form @submit.prevent="createData">
                        ...
                        <div class="mb-3 row">
                            <div class="col-lg-12">
                                <Label :name="__('Reason')" :required="false" for="reason"/>
                                <textarea class="form-control" v-model="form.reason" :class="{'is-invalid':form.errors.reason}" rows="5" id="reason" :placeholder="__('Reason')"></textarea>
