            ...
            <div class="card mt-3">
                ...
                <div class="card-body row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3 row">
                            <div class="col-lg-6">
                                <Label :name="__('Change Password')" :required="false" for="change_password"/>
                                <input v-model="form.password" type="password" class="form-control"
                                    :class="{'is-invalid':form.errors.password}" id="change_password" :placeholder="__('Change Password')">
