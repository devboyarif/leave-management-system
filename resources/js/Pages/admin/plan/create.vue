<template>
    <Head :title="__('Plan Create')"/>
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card mt-3">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title">{{ __('Plan Create') }}</h3>
                ...
                <div class="card-body row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3 row">
                            <div class="col-lg-6">
                                <Label :name="__('Price')" for="price"/>
                                <input v-model="form.price" type="text" class="form-control"
                                    :class="{'is-invalid':form.errors.price}" :placeholder="__('Price')" id="price">
                        ...
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-6" :class="{'mt-2': !showMaxEmployeeField}">
                                <Label :name="__('Custom Theme Look')" :required="false"/> <br>
                                <label class="switch ">
                                    <input @change="customLookStatusChange" v-model="form.custom_theme_look" type="checkbox" class="success toggle-switch" checked>
                                    <span class="slider round"></span>
                                </label>
