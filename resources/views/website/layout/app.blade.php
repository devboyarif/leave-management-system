            ...
            <div class="row">
                    ...
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="{{ asset('website') }}/images/testimonials/author-01.png" alt="author" />
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="{{ asset('website') }}/images/testimonials/author-02.png" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4>Margin Gesmu</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="{{ asset('website') }}/images/testimonials/author-03.png" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4>William Smith</h4>
                    ...
                    <div class="ud-brands wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="ud-brands-logo">
                            <div class="ud-single-logo">
                                <img src="{{ asset('website') }}/images/brands/ayroui.svg" alt="ayroui" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('website') }}/images/brands/uideck.svg" alt="uideck" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('website') }}/images/brands/graygrids.svg" alt="graygrids" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('website') }}/images/brands/lineicons.svg" alt="lineicons" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="{{ asset('website') }}/images/brands/ecommerce-html.svg"
                                    alt="ecommerce-html" />
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="ud-widget-brands">
                                <li>
                                    <a href="https://ayroui.com/" rel="nofollow noopner" target="_blank">
                                        <img src="{{ asset('website') }}/images/footer/brands/ayroui.svg"
                                            alt="ayroui" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://ecommercehtml.com/" rel="nofollow noopner" target="_blank">
                                        <img src="{{ asset('website') }}/images/footer/brands/ecommerce-html.svg"
                                            alt="ecommerce-html" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://graygrids.com/" rel="nofollow noopner" target="_blank">
                                        <img src="{{ asset('website') }}/images/footer/brands/graygrids.svg"
                                            alt="graygrids" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://lineicons.com/" rel="nofollow noopner" target="_blank">
                                        <img src="{{ asset('website') }}/images/footer/brands/lineicons.svg"
                                            alt="lineicons" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://uideck.com/" rel="nofollow noopner" target="_blank">
                                        <img src="{{ asset('website') }}/images/footer/brands/uideck.svg"
                                            alt="uideck" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://tailwindtemplates.co/" rel="nofollow noopner" target="_blank">
                                        <img src="{{ asset('website') }}/images/footer/brands/tailwindtemplates.svg"
